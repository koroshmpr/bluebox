...
function bluebox_html5_comment( $comment, $args, $depth ) {
	...
	<<?php echo esc_attr( $tag ); ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $comment->has_children ? 'parent' : '', $comment ); ?>>
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="comment-meta">
				<div class="comment-author vcard">
					...
					printf(
						...
						wp_kses_post( __( '%s <span class="says">says:</span>', 'bluebox' ) ),
				...
				<div class="comment-metadata">
					...
					edit_comment_link( __( 'Edit', 'bluebox' ), ' <span class="edit-link">', '</span>' );
					?>
			...
			<div <?php bluebox_content_class( 'comment-content' ); ?>>
				<?php comment_text(); ?>
			</div><!-- .comment-content -->
