...
$linkClass = 'bg-white/5 p-2 !text-white rounded-sm hover:bg-white/10 transition-all';
$svgSize = '15';
?>

<div class="<?= $args['class'] ?? ''; ?> flex gap-x-2 mt-5 lg:pb-5 items-center justify-center w-fit mx-auto text-white">
